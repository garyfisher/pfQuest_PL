...
function pfQuest:AddQuestLogIntegration()
  ...
  pfQuest.buttonShow:SetFont("Interface\\AddOns\\pfQuest\\Fonts\\frizquadratatt_pl.ttf", 12)
  ...
  pfQuest.buttonClean:SetFont("Interface\\AddOns\\pfQuest\\Fonts\\frizquadratatt_pl.ttf", 12)
