local locales = {
  ...
  ["enUS"] = {
    ["Alliance"] = "Przymierze",
    ["All Quests"] = "Wszystkie zadania",
    ["and"] = "i",
    ["Area/Zone"] = "Obszar/Strefa",
    ["Buy"] = "Kup",
    ["|cff33ffcc<Click>|r Unfold/Fold Objectives\n|cff33ffcc<Right-Click>|r Show In QuestLog\n|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Klik>|r Rozwiń/Zwiń cele\n|cff33ffcc<Prawy-Klik>|r Pokaż w dzienniku\n|cff33ffcc<Ctrl-Klik>|r Pokaż mapę / Przełącz kolor\n|cff33ffcc<Shift-Klik>|r Ukryj węzły",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Ctrl-Klik>|r Pokaż mapę / Przełącz kolor\n|cff33ffcc<Shift-Klik>|r Ukryj węzły",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Mark As Done"] = "|cff33ffcc<Ctrl-Klik>|r Pokaż mapę / Przełącz kolor\n|cff33ffcc<Shift-Klik>|r Oznacz jako ukończone",
    ["|cff33ffccpf|cffffffffQuest: Tracker is now hidden. Type `/db tracker` to show."] = "|cff33ffccpf|cffffffffQuest: Tracker jest teraz ukryty. Wpisz `/db tracker`, aby go pokazać.",
    ["|cff33ffccpf|rQuest: New version available! Have a look at http://shagu.org !"] = "|cff33ffccpf|rQuest: Nowa wersja dostępna! Sprawdź http://shagu.org !",
    ["Clean"] = "Wyczyść",
    ["Clean Database Results"] = "Wyczyść wyniki bazy danych",
    ["Clean Map"] = "Wyczyść mapę",
    ["Click Node To Change Color"] = "Kliknij węzeł, aby zmienić kolor",
    ["Close"] = "Zamknij",
    ["Close & Reload"] = "Zamknij i przeładuj",
    ["Close Tracker"] = "Zamknij tracker",
    ["Color Map Nodes By Spawn"] = "Koloruj węzły mapy wg pojawień",
    ["Combined"] = "Połączone",
    ["Completed Level"] = "Ukończony poziom",
    ["Config"] = "Konfiguracja",
    ["custom items loaded."] = "niestandardowe przedmioty załadowane.",
    ["Display addon locales"] = "Pokaż lokalizacje dodatku",
    ["Display all spawn points of each quest objective and hide summarized cluster icons."] = "Pokaż wszystkie punkty pojawienia się każdego celu zadania i ukryj zsumowane ikony klastrów.",
    ["Display Available Quest Givers"] = "Pokaż dostępnych zleceniodawców",
    ["Display Current Quest Givers"] = "Pokaż obecnych zleceniodawców",
    ["Display Event & Daily Quests"] = "Pokaż zadania eventowe i dzienne",
    ["Display Level+3 Quest Givers"] = "Pokaż zleceniodawców zadań poziom +3",
    ["Display Low Level Quest Givers"] = "Pokaż zleceniodawców zadań niskopoziomowych",
    ["Display related creatures and NPCs"] = "Pokaż powiązane stworzenia i NPC",
    ["Display related items"] = "Pokaż powiązane przedmioty",
    ["Display related objects like ores, herbs, chests, etc."] = "Pokaż powiązane obiekty: rudy, zioła, skrzynie itp.",
    ["Display related quests"] = "Pokaż powiązane zadania",
    ["Distance"] = "Odległość",
    ["Do you really want to reset everything?"] = "Czy na pewno chcesz zresetować wszystko?",
    ["Do you really want to reset the caches?"] = "Czy na pewno chcesz zresetować pamięć podręczną?",
    ["Do you really want to reset the configuration?"] = "Czy na pewno chcesz zresetować konfigurację?",
    ["Do you really want to reset the quest history?"] = "Czy na pewno chcesz zresetować historię zadań?",
    ["Draw Favorites On Login"] = "Rysuj ulubione przy logowaniu",
    ["Enable Minimap Button"] = "Włącz przycisk minimapy",
    ["Enable Minimap Nodes"] = "Włącz węzły na minimapie",
    ["Enable Quest Link Support"] = "Włącz obsługę linków zadań",
    ["Enable Quest Log Buttons"] = "Włącz przyciski dziennika zadań",
    ["Enable Quest Tracker"] = "Włącz tracker zadań",
    ["Enable World Map Menu"] = "Włącz menu mapy świata",
    ["Exploration Mark"] = "Znacznik eksploracji",
    ["Explore"] = "Eksploruj",
    ["Explore |cff33ffcc%s|r"] = "Eksploruj |cff33ffcc%s|r",
    ["Friendly"] = "Przyjazny",
    ["General"] = "Ogólne",
    ["Herbalism"] = "Zielarstwo",
    ["Hide"] = "Ukryj",
    ["Hide browser window"] = "Ukryj okno przeglądarki",
    ["Hide Quests"] = "Ukryj zadania",
    ["Highlight Nodes On Mouseover"] = "Podświetlaj węzły po najechaniu",
    ["Hold <Ctrl> To Hide Cluster"] = "Przytrzymaj <Ctrl>, aby ukryć klaster",
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Przytrzymaj <Ctrl>, aby ukryć węzły minimapy",
    ["Horde"] = "Horda",
    ["Hostile"] = "Wrogi",
    ["Include Quest Enders"] = "Uwzględnij zakończenia zadań",
    ["Include Quest Starters"] = "Uwzględnij rozpoczęcia zadań",
    ["Include Unified Quest Locations"] = "Uwzględnij zunifikowane lokalizacje zadań",
    ["Interact with |cff33ffcc%s|r"] = "Wejdź w interakcję z |cff33ffcc%s|r",
    ["Interact with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "Wejdź w interakcję z |cff33ffcc%s|r, aby ukończyć |cffffcc00[?]|cff33ffcc %s|r",
    ["Interact with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "Wejdź w interakcję z |cff33ffcc%s|r, aby rozpocząć |cffffcc00[!]|cff33ffcc %s|r",
    ["Items"] = "Przedmioty",
    ["Journal"] = "Dziennik",
    ["Kill |cff33ffcc%s|r"] = "Zabij |cff33ffcc%s|r",
    ["Left-Click"] = "Lewy-Klik",
    ["Level"] = "Poziom",
    ["Locales"] = "Lokalizacje",
    ["Location"] = "Lokalizacja",
    ["Loot"] = "Łup",
    ["Loot and/or Use |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Zdobądź i/lub użyj |cff33ffcc[%s]|r od |cff33ffcc%s|r",
    ["Loot |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Zdobądź |cff33ffcc[%s]|r od |cff33ffcc%s|r",
    ["Looted from"] = "Łup z",
    ["Manual Selection"] = "Reczny wybór",
    ["Map & Minimap"] = "Mapa i minimapa",
    ["Minimap Node Transparency"] = "Przezroczystość węzłów minimapy",
    ["Minimum Item Drop Chance"] = "Minimalna szansa na upuszczenie",
    ["Mining"] = "Górnictwo",
    ["Move Button"] = "Przycisk przenoszenia",
    ["N/A"] = "Brak",
    ["Navigation Arrow"] = "Strzałka nawigacji",
    ["Node Fade Transparency"] = "Przezroczystość zanikania węzłów",
    ["Object"] = "Obiekt",
    ["Objects"] = "Obiekty",
    ["Online Search"] = "Wyszukiwanie online",
    ["Only show cluster icons with summarized objective locations based on spawn points"] = "Pokaż tylko ikony klastrów ze zsumowanymi lokalizacjami celów na podstawie punktów pojawienia",
    ["Open Browser"] = "Otwórz przeglądarkę",
    ["Open Configuration"] = "Otwórz konfigurację",
    ["Open Database Browser"] = "Otwórz przeglądarkę bazy danych",
    ["Open Settings"] = "Otwórz ustawienia",
    ["others"] = "inne",
    ["Please select your preferred |cff33ffccpf|cffffffffQuest|r mode:"] = "Wybierz preferowany tryb |cff33ffccpf|cffffffffQuest|r:",
    ["Query the server for completed quests"] = "Zapytaj serwer o ukończone zadania",
    ["Quest End"] = "Koniec zadania",
    ["Quest history migration completed."] = "Migracja historii zadań zakończona.",
    ["Questing"] = "Zadania",
    ["Quest Level"] = "Poziom zadania",
    ["Quest Objective Icons (Mini Map)"] = "Ikony celów zadania (minimapa)",
    ["Quest Objective Icons (World Map)"] = "Ikony celów zadania (mapa świata)",
    ["Quest Objective Spawn Points (Mini Map)"] = "Punkty pojawienia celów zadania (minimapa)",
    ["Quest Objective Spawn Points (World Map)"] = "Punkty pojawienia celów zadania (mapa świata)",
    ["Quests"] = "Zadania",
    ["Quest Start"] = "Początek zadania",
    ["Quest Tracker Font Size"] = "Rozmiar czcionki trackera zadań",
    ["Quest Tracker Unfold Objectives"] = "Rozwiń cele w trackerze zadań",
    ["Quest Tracker Visibility"] = "Widoczność trackera zadań",
    ["Reaction"] = "Reakcja",
    ["Remove all manually searched objects from the map"] = "Usuń wszystkie ręcznie wyszukiwane obiekty z mapy",
    ["Required"] = "Wymagane",
    ...
    ["Reset Language"] = "Resetuj jezyk",
    ["Reset Map"] = "Resetuj mapę",
    ["Reset Quest History"] = "Resetuj historię zadań",
    ["Respawn"] = "Odrodzenie",
    ["Right-Click"] = "Prawy-Klik",
    ["Routes"] = "Trasy",
    ["Save & Close"] = "Zapisz i zamknij",
    ["Scanning server for items..."] = "Skanowanie serwera w poszukiwaniu przedmiotów...",
    ["Scan the server for custom items"] = "Zeskanuj serwer w poszukiwaniu niestandardowych przedmiotów",
    ["Search"] = "Szukaj",
    ["Search item vendors"] = "Szukaj sprzedawców przedmiotu",
    ["Search loot"] = "Szukaj łupu",
    ["Search object"] = "Szukaj obiektu",
    ["Search unit"] = "Szukaj jednostki",
    ["Server scan started..."] = "Skanowanie serwera rozpoczęte...",
    ["Shift-Click"] = "Shift-Klik",
    ["Show"] = "Pokaż",
    ["Show all chests on map"] = "Pokaż wszystkie skrzynie na mapie",
    ["Show all quests on map"] = "Pokaż wszystkie zadania na mapie",
    ["Show all rare mobs of Level [min] to [max]"] = "Pokaż wszystkie rzadkie moby od poziomu [min] do [max]",
    ["Show all taxi nodes of [faction]"] = "Pokaż wszystkie punkty taxi [frakcji]",
    ["Show Arrow Along Routes"] = "Pokaż strzałkę wzdłuż tras",
    ["Show cluster icons with summarized locations and also display all spawn points of each quest objective"] = "Pokaż ikony klastrów ze zsumowanymi lokalizacjami oraz wszystkie punkty pojawienia każdego celu zadania",
    ["Show configuration interface"] = "Pokaż interfejs konfiguracji",
    ["Show Current Quests"] = "Pokaż obecne zadania",
    ["Show Database IDs"] = "Pokaż ID bazy danych",
    ["Show database interface"] = "Pokaż interfejs bazy danych",
    ["Show Database Results"] = "Pokaż wyniki bazy danych",
    ["Show Help On Tooltips"] = "Pokaż pomoc w podpowiedziach",
    ["Show herbs with an appropriate skill level for your character"] = "Pokaż zioła odpowiednie dla poziomu umiejętności twojej postaci",
    ["Show herbs with skill range of [min] to [max]"] = "Pokaż zioła z zakresem umiejętności od [min] do [max]",
    ["Show Level On Quest Log"] = "Pokaż poziom w dzienniku zadań",
    ["Show Level On Quest Tracker"] = "Pokaż poziom w trackerze zadań",
    ["Show map tracker"] = "Pokaż tracker mapy",
    ["Show mines with an appropriate skill level for your character"] = "Pokaż kopalnie odpowiednie dla poziomu umiejętności twojej postaci",
    ["Show mines with skill range of [min] to [max]"] = "Pokaż kopalnie z zakresem umiejętności od [min] do [max]",
    ["Show Navigation Arrow"] = "Pokaż strzałkę nawigacji",
    ["Show navigation arrow that points you to the nearest quest location."] = "Pokaż strzałkę nawigacji wskazującą najbliższą lokalizację zadania.",
    ["Show quest arrow"] = "Pokaż strzałkę zadania",
    ["Show Quest Givers"] = "Pokaż zleceniodawców",
    ["Show quest journal"] = "Pokaż dziennik zadań",
    ["Show Route Between Objects"] = "Pokaż trasę między obiektami",
    ["Show Route On Minimap"] = "Pokaż trasę na minimapie",
    ["Show specific quest"] = "Pokaż konkretne zadanie",
    ["Show Tooltips"] = "Pokaż podpowiedzi",
    ["Simple Markers"] = "Proste znaczniki",
    ["Sold by"] = "Sprzedawane przez",
    ["Spawn Points"] = "Punkty pojawienia",
    ["Speak with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "Porozmawiaj z |cff33ffcc%s|r, aby ukończyć |cffffcc00[?]|cff33ffcc %s|r",
    ["Speak with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "Porozmawiaj z |cff33ffcc%s|r, aby rozpocząć |cffffcc00[!]|cff33ffcc %s|r",
    ["Talk to |cff33ffcc%s|r"] = "Porozmawiaj z |cff33ffcc%s|r",
    ["Toggle completed quest browser"] = "Przełącz przeglądarkę ukończonych zadań",
    ["Too many entries. Results shown"] = "Zbyt wiele wyników. Pokazano część",
    ["Tracked Quests"] = "Sledzone zadania",
    ["Translate"] = "Tłumacz",
    ["Trigger"] = "Wyzwalacz",
    ["Type"] = "Typ",
    ["Unit"] = "Jednostka",
    ["Units"] = "Jednostki",
    ["Use |cff33ffcc%s|r at |cff33ffcc%s|r"] = "Użyj |cff33ffcc%s|r przy |cff33ffcc%s|r",
    ["Use |cff33ffcc%s|r on |cff33ffcc%s|r"] = "Użyj |cff33ffcc%s|r na |cff33ffcc%s|r",
    ["Use Cut-Out Minimap Node Icons"] = "Użyj wyciętych ikon węzłów minimapy",
    ["Use Cut-Out World Map Node Icons"] = "Użyj wyciętych ikon węzłów mapy świata",
    ["Use Monochrome Cluster Icons"] = "Użyj monochromatycznych ikon klastrów",
    ["Use Quest Item at |cff33ffcc%s|r"] = "Użyj przedmiotu zadania przy |cff33ffcc%s|r",
    ["User Data"] = "Dane użytkownika",
    ["Use <Shift>-Click To Mark Quest As Done"] = "Użyj <Shift>-Klik, aby oznaczyć zadanie jako ukończone",
    ["Use <Shift>-Click To Remove Nodes"] = "Użyj <Shift>-Klik, aby usunąć węzły",
    ["Vendor"] = "Sprzedawca",
    ["Welcome Screen"] = "Ekran powitalny",
    ["World Map Node Transparency"] = "Przezroczystość węzłów mapy świata",
    ["You already did this quest."] = "Już ukończyłeś to zadanie.",
    ["You are on this quest."] = "Masz już to zadanie.",
    ["You don't have this quest."] = "Nie masz tego zadania.",
  },
}
